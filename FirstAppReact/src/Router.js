...
import {destActivityDetails, MainMenuScreen,destActivityList, FirebaseAuth} from './destactivity';
...
export class Router extends Component {
    ...
    render() {
        ...
        return (
            <Navigator
                initialRoute={FirebaseAuth.route}
        ...
        switch (route.name) {
            ...
            case MainMenuScreen.routeName:
                return <MainMenuScreen
                    ...
                    navigator={navigator}/>
           case DestActivityDetails.routeName:
                return <SportActivityDetails
                    store={this.props.store}
                    navigator={navigator}/>
            case FirebaseAuth.routeName:
                return <FirebaseAuth
                    store={this.props.store}
                    navigator={navigator}/>
            
            
            case DestActivityList.routeName:
            default:
    ...
    onAuthSucceeded() {
        ...
        this.navigator.push(destActivityList.route);
    }
}
